...
The stimuli were, adapted from previous studies with simular language combiations, [@llama_influence_2010; @llama_revisiting_2018] were words with word initial stops of either one or two syllables, with stress on the initial syllable (see Table 2).
