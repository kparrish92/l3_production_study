...
subtitle: 'Phon & phon at AMU, Fall 2021'
author  : "Kyle Parrish"
...
tidy_df %>% 
  ...
  pivot_longer(c(`English French difference`, `English Spanish difference`), names_to = "pair", values_to = "differnce") %>% 
  ggplot(aes(x = differnce, y = participant, color = pair)) + geom_point() +
...
tidy_df %>% 
  ...
  pivot_longer(c(`sp_eng_diff`, `sp_fr_diff`), names_to = "pair", values_to = "differnce") %>% 
  ggplot(aes(x = differnce, y = participant, color = pair)) + geom_jitter() +
